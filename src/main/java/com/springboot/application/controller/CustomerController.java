...
import com.springboot.application.entities.Credential;
import com.springboot.application.entities.Transaction;
...
public class CustomerController {
    ...
    public ResponseEntity<String> pay(@RequestBody Transaction transaction){
        ...
        return new ResponseEntity<>("Payment sucessfull", HttpStatus.ACCEPTED);
